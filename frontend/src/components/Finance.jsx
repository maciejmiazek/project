			...
			<div className='left-panel'>
				...
				<div className='middle-row'>
					...
					>
						...
						<p className='amount centered'>
							{financeData[0]?.costs.reduce((acc, item) => acc + item[2], 0)}{" "}
							PLN
						</p>
					</div>
					<div className='icons-grid'>
						<button
							onClick={() => handleIconClick("Statystyki")}
						...
						<button
							onClick={() => handleIconClick("Pracownicy")}
							className='icon-button'
						>
							<IconUser stroke={2} />
							<div className='desc'>
						...
						<button
							onClick={() => handleIconClick("Narzędzia")}
							className='icon-button'
						>
							<IconTool stroke={2} />
							<div className='desc'>
						...
						<button
							onClick={() => handleIconClick("Analiza")}
							className='icon-button'
						>
						...
						<button
							onClick={() => handleIconClick("Magazyn")}
							className='icon-button'
						>
						...
						<button
							onClick={() => handleIconClick("Dokumenty")}
							className='icon-button'
						>
							<IconNotes stroke={2} />
							<div className='desc'>
				...
				<div className='bottom-row'>
					...
					>
						...
						<p className='amount centered'>
							{financeData[0]?.gains.reduce((acc, item) => acc + item[2], 0)}{" "}
							PLN
						</p>
					</div>
					<div className='icons-grid bottom-icons'>
						<button
							onClick={() => handleIconClick("Tabela")}
							className='icon-button'
						>
							<IconBorderAll stroke={2} />
							<div className='desc'>
				...
				<div className='costs-panel'>
					...
					<div className='costs-list'>
						{activeButton === 0 && buttonChange === 0 ? (
							...
							financeData[0]?.gains.map((item, index) => (
								<div
									key={index}
									className='cost-item'
								>
