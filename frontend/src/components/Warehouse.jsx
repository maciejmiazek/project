			...
			<div className='warehouse'>
					...
					<div className='items-list'>
						{filteredItems.map((item, index) => (
							...
							>
								...
								{selectedItem?.name === item.name && activeButton === 1 ? (
									<div
				...
				<div className='right-panel'>
					<div className='history-section'>
						...
						<button
							className={`new-display ${activeButton === 1 ? "active" : ""}`}
							onClick={() => {
								setActiveButton(1);
							}}
						>
						...
						{selectedItem && activeButton === 0 ? (
													...
													<div
														...
														onClick={() => {
															selectedHistoryIndex !== histIndex
																? setSelectedHistoryIndex(histIndex)
																: setSelectedHistoryIndex(null);
														}}
													>
														<p
															className={`amount ${
																hist[0] ? "positive" : "negative"
															}`}
														>
															{hist[0] ? "+" : "-"}
															{hist[1]}
								...
								<div className='quantity-controls'>
									<form onSubmit={createHandle}>
										<button
											type='button'
											onClick={() => {
												setSelectedButton(0), handleClick;
											}}
										...
										<button
											type='button'
											onClick={() => {
												setSelectedButton(1), handleClick;
											}}
							...
							<form onSubmit={createHandle}>
								...
								<div className='form-bulk'>
									...
									<select
										name='category'
										value={formData["magazyn"].category}
										onChange={handleChange}
									>
